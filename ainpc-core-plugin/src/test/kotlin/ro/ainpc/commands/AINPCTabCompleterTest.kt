...
class AINPCTabCompleterTest {
    ...
    fun completesNpcDemoInspectionAndRepairCommands() {
        ...
        assertTrue(tab(completer, "ainpc", "authoring", "").contains("clear"))
        assertTrue(tab(completer, "ainpc", "authoring", "").contains("dump"))
        assertTrue(tab(completer, "ainpc", "quest", "").contains("authoring"))
        assertTrue(tab(completer, "ainpc", "quest", "authoring", "").contains("next"))
        assertTrue(tab(completer, "ainpc", "quest", "authoring", "").contains("dump"))
