...
object SpawnBatchPlanHasher {
    ...
    private fun appendResident(canonical: StringBuilder, resident: HouseAllocation.ResidentPlan) {
        canonical.append("resident|")
            ...
            .append(clean(resident.socialRole())).append('|')
            .append(clean(resident.ageGroup())).append('|')
            .append(clean(resident.routineProfile())).append('|')
            .append(clean(resident.questRole())).append('|')
            .append(clean(resident.backstorySeed())).append('|')
