...
| `pregatire-questuri-avansate.md` | 2, 4 | Pregatiri minime inainte de Q06-Q08 si stages | Stabilizeaza `objective_id`, auditul si smoke testul inainte de branching sau mai multe questuri active |
