...
class QuestCreatorScreensDiagnosticsTest {
    ...
    fun questCreateGui() {
        ...
        assertTrue(src.contains("quest_reward_event_payload"))
        assertTrue(src.contains("isShiftClick"))
        assertTrue(src.contains("quest_obj_type"))
        assertTrue(src.contains("quest_base"))
        assertTrue(src.contains("Shift-click: ruleaza presetul urmator."))
        assertTrue(src.contains("quest_reward_value"))
        assertTrue(src.contains("quest_dialog_type"))
        assertTrue(src.contains("Shift-click: ruleaza valoarea preset urmatoare."))
        assertTrue(src.contains("quest_reward_event_scope"))
        assertTrue(src.contains("quest_reward_event_target"))
        assertTrue(src.contains("quest_reward_event_key"))
        assertTrue(src.contains("quest_reward_event_title"))
        assertTrue(src.contains("quest_dialog_speaker"))
        assertTrue(src.contains("Reset Obiectiv"))
        assertTrue(src.contains("Reset Recompensa"))
        assertTrue(src.contains("Reset Dialog"))
        assertTrue(src.contains("Reset All Draft"))
        assertTrue(src.contains("quest reset-objective"))
        assertTrue(src.contains("quest reset-reward"))
        assertTrue(src.contains("quest reset-dialog"))
        assertTrue(src.contains("quest reset-draft"))
        assertTrue(src.contains("quest preview"))
        assertTrue(src.contains("quest preview [jucator]"))
        assertTrue(src.contains("quest validate"))
        assertTrue(src.contains("Quest Draft Preview"))
        assertTrue(src.contains("Quest Draft Validation"))
        assertTrue(src.contains("Status: completabil"))
        assertTrue(src.contains("Preview JSON"))
        assertTrue(src.contains("Validate Draft"))
        assertTrue(src.contains("Preview in chat"))
        assertTrue(src.contains("Shift-click: ruleaza scope-ul preset urmator."))
        assertTrue(src.contains("Shift-click: ruleaza target-ul preset urmator."))
        assertTrue(src.contains("Shift-click: ruleaza event key preset urmator."))
        assertTrue(src.contains("Shift-click: ruleaza titlul preset urmator."))
        assertTrue(src.contains("Shift-click: ruleaza vorbitorul preset urmator."))
