...
class NpcWorldBindingServiceTest {
    ...
    private lateinit var service: NpcWorldBindingService
    ...
    fun setUp() {
        ...
        service = NpcWorldBindingService(connection!!::prepareStatement, Logger.getLogger("NpcWorldBindingServiceTest"))
    }
    ...
    @Test
    @Throws(Exception::class)
    fun savesAndReadsNpcWorldBinding() {
        service.saveBinding(
            NpcWorldBinding(
                42,
                "uuid-42",
    ...
    @Test
    @Throws(Exception::class)
    fun mergeMissingFieldsPreservesExistingWorkAndSocialBinding() {
        val existing = service.saveBinding(
            NpcWorldBinding(
                7,
                "uuid-7",
                "Ana",
        ...
        val manualHomeOnly = NpcWorldBinding(
            7,
            "uuid-7",
            "Ana",
            "demo_sat:house_2",
