...
fun sendQuestUsage(sender: CommandSender) {
    ...
    msg.send(sender, "&e/ainpc quest authoring [next|prev|previous|clear|reset|summary|dump [questSelector] [mechanicId]]")
...
fun sendHelp(sender: CommandSender) {
    ...
    msg.send(sender, "&e/ainpc authoring [next|prev|clear|summary|questSelector [mechanicId] | dump [questSelector] [mechanicId]]")
    msg.send(sender, "&7  Deschide snapshot-ul read-only de authoring sau il afiseaza filtrat in chat")
    msg.send(sender, "&e/ainpc quest authoring [next|prev|previous|clear|reset|summary|dump [questSelector] [mechanicId]]")
    msg.send(sender, "&7  Alias quest-side pentru authoring-ul read-only, summary si dump-ul text")
    msg.send(sender, "&e/ainpc quest <numeNpc> [jucator]")
    ...
    msg.send(sender, "&e/ainpc debugdump [all|npc|world|quest|story|mapping|routing|openai|runtime] [summary]")
