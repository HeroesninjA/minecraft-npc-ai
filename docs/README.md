...
13. `npc-population-world-stack.md`
14. `ordine-spawn-npc-cladiri-region-node.md`
15. `simulare-sat-si-lume.md`
16. `simulation-service.md`
17. `simulation-service-partea-2.md`
18. `simulation-service-partea-3.md`
19. `simulation-service-partea-4.md`
20. `simulation-stack.md`
21. `environment-context-si-engine.md`
22. `mapping-stack.md`
23. `interactiune-dialog-reactie-stack.md`
24. `dialog-si-conversatii.md`
25. `interactiuni.md`
26. `gui-stack.md`
27. `gui-interfete.md`
28. `ai-orchestrare-mcp-stack.md`
29. `ai-orchestrare-si-mecanici.md`
30. `spring-ai-mcp-serviciu-intern.md`
31. `story-context-quest-ai-stack.md`
32. `generare-automata-questuri-ai.md`
33. `story-si-context-ai.md`
34. `story-context-service.md`
35. `progression-service.md`
36. `progression-events-onboarding-stack.md`
37. `quest-evolution-stack.md`
38. `api-events-listeners-triggers.md`
39. `redundanta-si-consolidare.md`
40. `player-onboarding-initiere.md`
41. `lucru-alternat-quest-mapping-progression.md`
42. `roadmap-orientativ.md`
43. `server-admin-runbook.md`
...
Folosește `arhiva/kotlin-migration/README.md` pentru documentele istorice ale migrării.

## Harta relatiilor

Folosește `relatii-documentatie.md` ca sursă canonică pentru relațiile dintre documente.

## Regula de mentenanta

Cand codul schimba o faza din design in implementat initial, actualizeaza documentele afectate si, daca e cazul, `TODO.md`.
