...
class AINPCTabCompleter(private val plugin: AINPCPlugin?) : TabCompleter {
    override fun onTabComplete(
        ...
        if (args.size == 1) {
            ...
            when (subCommand) {
                ...
                "delete-id" -> {
                    if (args.size == 2) completions.addAll(getNPCIds(args[1])) else if (args.size == 3) completions.addAll(
                        filterStartsWith(listOf("confirm"), args[2])
                    )
                }
                ...
                "repair" -> {
                    if (args.size == 2) {
                        ...
                        if ("list".equals(args[2], true) || "recent".equals(args[2], true)) completions.addAll(
                            filterStartsWith(REPAIR_BATCH_LIST_FILTERS, args[3])
                        )
                ...
                "quest", "progression", "progress", "contract", "contracts", "duty", "duties", "sarcina", "sarcini", "bounty", "bounties", "event", "events", "eveniment", "evenimente", "tutorial", "tutorials", "onboarding", "ritual", "rituals", "ceremony", "ceremonies", "ceremonie", "ceremonii" -> {
                    ...
                    completions.addAll(
                        if (isProgressionAliasCommand(subCommand)) completeProgressionAliasArgs(questArgs) else completeQuestArgs(
                            questArgs
                        )
                    )
                }
                ...
                "gui" -> {
                    ...
                    else if (args.size == 3 && isProgressionGuiMode(args[1])) completions.addAll(
                        filterStartsWith(
                            GUI_QUEST_FILTERS,
                            args[2]
                        )
                ...
                "authoring" -> when (args.size) {
                    2 -> {
                        completions.addAll(AuthoringCommandSupport.modeSuggestions(args[1]))
                        completions.addAll(getAuthoringSelectorSuggestions(args[1]))
                    }
                    3 -> if ("dump".equals(args[1], true)) {
                        completions.addAll(getAuthoringSelectorSuggestions(args[2]))
                    } else {
                        completions.addAll(getAuthoringMechanicSuggestions(args[2]))
                    }
                ...
                "demo" -> {
                    ...
                    else if (args.size == 4 && DEMO_COMMAND_PLAYER_ACTIONS.any {
                            it.equals(
                                args[1],
                                true
                            )
                ...
                "wand" -> {
                    ...
                    else if (args.size == 3 && "mode".equals(args[1], true)) completions.addAll(
                        filterStartsWith(
                            WAND_MODES,
                            args[2]
                        )
                    )
                    else if (args.size == 3 && ("clear".equals(args[1], true) || "reset".equals(
                            args[1],
                            true
                        ))
                ...
                "map" -> {
                    ...
                    else if (args.size >= 3 && "quest_anchor".equals(args[1], true)) completions.addAll(
                        completeMapQuestAnchorArgs(sender, args)
                    )
                }
                ...
                "migration" -> {
                    ...
                    else if (args.size == 3 && "households".equals(args[1], true)) completions.addAll(
                        filterStartsWith(
                            MIGRATION_MODES,
                            args[2]
                        )
                    )
                    else if (args.size == 4 && "households".equals(args[1], true)) completions.addAll(
                        filterStartsWith(
                            listOf("100", "500", "1000"),
                            args[3]
                        )
        ...
        when (worldMode) {
            ...
            "outside" -> {
                if (args.size == 3) completions.addAll(filterStartsWith(OUTSIDE_ACTIONS, args[2]))
                    ...
                    completions.addAll(filterStartsWith(OUTSIDE_TYPES, args[3]))
                } else if (args.size == 4 && OUTSIDE_REGION_ACTIONS.any { it.equals(args[2], true) }) {
                    completions.addAll(getRegionIds(args[3]))
                } else if (args.size == 5 && "plan".equals(args[2], true)) {
                    completions.add("<baseId>")
                }
            }

            "fixture" -> {
                if (args.size == 3) completions.addAll(filterStartsWith(FIXTURE_ACTIONS, args[2]))
                else if (args.size == 4 && "plan".equals(args[2], true)) {
                    completions.addAll(filterStartsWith(FIXTURE_PREFIXES, args[3]))
                }
            }
            ...
            "region" -> {
                ...
                } else if (args.size == 5 && "create".equals(args[2], true)) completions.addAll(
                    filterStartsWith(
                        REGION_TYPES,
                        args[4]
                    )
                )
                else if (args.size >= 6 && args.size <= 11 && "create".equals(args[2], true)) completions.addAll(
                    getCoordinateSuggestions(sender, args[args.size - 1])
                )
            }
            ...
            "place" -> {
                ...
                else if (args.size == 6 && "create".equals(args[2], true)) completions.addAll(
                    filterStartsWith(
                        PLACE_TYPES,
                        args[5]
                    )
                )
                else if (args.size >= 7 && args.size <= 12 && "create".equals(args[2], true)) completions.addAll(
                    getCoordinateSuggestions(sender, args[args.size - 1])
                )
            }
            ...
            "node" -> {
                ...
                else if (args.size == 7 && "create".equals(args[2], true)) completions.addAll(
                    filterStartsWith(
                        NODE_TYPES,
                        args[6]
                    )
                )
                else if (args.size >= 8 && args.size <= 10 && "create".equals(args[2], true)) completions.addAll(
                    getCoordinateSuggestions(sender, args[args.size - 1])
                )
                else if (args.size == 11 && "create".equals(
                        args[2],
                        true
                    )
                ) completions.addAll(filterStartsWith(listOf("1.5", "2.5", "4.0", "6.0"), args[10]))
            }

            "scan" -> {
                if (args.size == 3) completions.addAll(filterStartsWith(SCAN_TARGETS, args[2]))
                else if (args.size == 4 && "village".equals(
                        args[2],
                        true
                    )
                ) completions.addAll(filterStartsWith(listOf("32", "48", "64", "80"), args[3]))
                else if (args.size == 5 && "village".equals(
                        args[2],
                        true
                    )
                ) completions.addAll(filterStartsWith(listOf("import"), args[4]))
                else if (args.size == 6 && "village".equals(args[2], true) && "import".equals(
                        args[4],
                        true
                    )
            ...
            "binding", "bindings" -> {
                ...
                else if ((args.size == 4 && "list".equals(args[2], true)) || (args.size == 5 && "place".equals(
                        args[2],
                        true
                    ))
                ) completions.addAll(filterStartsWith(listOf("10", "20", "50"), args[args.size - 1]))
            }
            ...
            "household" -> {
                ...
                if (args.size == 3) completions.addAll(filterStartsWith(generationActions(HOUSEHOLD_ACTIONS), args[2]))
                else if (args.size == 4 && planActions.any { it.equals(args[2], true) }) completions.addAll(
                    getPlaceIds(
                        args[3]
                    )
                )
                else if (args.size == 4 && ("status".equals(args[2], true) || "place".equals(
                        args[2],
                        true
                    ))
                    ...
                    completions.addAll(filterStartsWith(listOf("nearest"), args[3]))
                    completions.addAll(getNPCNames(args[3]))
                } else if (args.size == 4 && "list".equals(
                        args[2],
                        true
                    )
                ) completions.addAll(filterStartsWith(listOf("10", "20", "50"), args[3]))
                else if (args.size == 5 && planActions.any { it.equals(args[2], true) }) completions.addAll(
                    filterStartsWith(listOf("1", "2", "3", "4"), args[4])
                )
            }
            ...
            "settlement" -> {
                ...
                else if (args.size == 4 && settlementActions.any { it.equals(args[2], true) }) completions.addAll(
                    getRegionIds(args[3])
                )
                else if (args.size == 5 && settlementActions.any { it.equals(args[2], true) }) completions.addAll(
                    filterStartsWith(listOf("1", "2", "4", "8"), args[4])
                )
            }
        }
        return completions
    ...
    private fun generationActions(actions: List<String>): List<String> =
        if (generationFeatureEnabled()) actions else actions.filterNot {
            it.equals("spawn", true) || it.equals(
                "create",
                true
            )
        }
    ...
    private fun completeQuestArgs(questArgs: Array<String>): List<String> {
        ...
        when (questArgs.size) {
            ...
            3 -> {
                ...
                } else if ((questMode == "track" || questMode == "current") && ("start".equals(
                        questArgs[1],
                        true
                    ) || "stop".equals(questArgs[1], true))
                ) {
                    completions.addAll(getOnlinePlayerNames(questArgs[2]))
                }
            }
    ...
    private fun completeProgressionAliasArgs(questArgs: Array<String>): List<String> {
        if (questArgs.size == 2 && ("gui".equals(questArgs[0], true) || "log".equals(
                questArgs[0],
                true
            ))
    ...
    private fun getQuestAnchorObjectiveIds(
        sender: CommandSender,
        ...
        val targetPlayer = resolveQuestAnchorPlayer(sender, playerSelector) ?: return filterStartsWith(
            listOf("<objective_id>"),
            prefix
        )
    ...
    private fun resolveQuestAnchorPlayer(sender: CommandSender, playerSelector: String?): Player? {
        ...
        if (safeSelector.isBlank() || "player:self".equals(safeSelector, true) || "jucator:self".equals(
                safeSelector,
                true
            ) || "self".equals(safeSelector, true)
        ) {
    ...
    private fun getAuthoringSelectorSuggestions(prefix: String): List<String> {
        return getProgressionSelectors(prefix)
    }

    private fun getAuthoringMechanicSuggestions(prefix: String): List<String> {
        val progressionService = plugin?.progressionService ?: return filterStartsWith(listOf("<mechanicId>"), prefix)
        val mechanics = progressionService.getDefinitions()
    ...
    private fun getOnlinePlayerNamesSafe(prefix: String): List<String> {
        return if (plugin?.server == null) filterStartsWith(
            listOf("<player>"),
            prefix
        ) else getOnlinePlayerNames(prefix)
    }
    ...
    private fun getPlaceIdsForRegion(regionSelector: String, prefix: String): List<String> {
        return (plugin?.platform?.worldAdmin?.places ?: return listOf()).stream()
            .filter { place ->
                place.regionId().equals(regionSelector, true) || place.id().lowercase()
                    .startsWith(regionSelector.lowercase() + ":")
            }
            .map(WorldPlaceInfo::id)
            .filter { id -> id.lowercase().startsWith(prefix.lowercase()) }
            .sorted()
    ...
    companion object {
        ...
        private val DEMO_COMMAND_ACTIONS = listOf(
            "status",
            "check",
            "readiness",
            "next",
        ...
        private val DEMO_COMMAND_REGION_ACTIONS = listOf(
            "status",
            "check",
            "readiness",
            "next",
        ...
        private val DEMO_COMMAND_PLAYER_ACTIONS = listOf(
            "script",
            "guide",
            "flow",
            "phases",
        ...
        private val REPAIR_BATCH_MODES =
            listOf("dryrun", "apply", "inspect", "steps", "mark-steps", "sync-steps", "mark-failed")
        private val REPAIR_BATCH_KEYS = listOf("list", "recent", "<batchKey>")
        private val REPAIR_BATCH_LIST_FILTERS =
            listOf("problem", "all", "failed", "running", "rolled_back", "succeeded")
        ...
        private val QUEST_LOG_FILTERS = listOf(
            "active",
            "current",
            "tracked",
            "quest",
        ...
        private val GUI_QUEST_FILTERS =
            listOf("all", "active", "quest", "contract", "duty", "bounty", "event", "tutorial", "ritual")
        private val GUI_ALIAS_FILTERS =
            listOf("all", "active", "current", "tracked", "offered", "completed", "failed", "archived")
        private val PROGRESSION_STORED_FILTERS = listOf(
            "all",
            "active",
            "current",
            "tracked",
            ...
            "scenario:ritual",
            "base:RITUAL",
            "mechanic:village_rituals",
            "status:active",
            "tracked:true",
            "resolved:false"
        )
        private val PROGRESSION_DEFINITION_FILTERS = listOf(
            "all",
            "quest",
            "contract",
            "duty",
        ...
        private val WORLD_MODES = listOf(
            "whereami",
            "places",
            "outside",
            "fixture",
        ...
        private val EMOTIONS =
            listOf("happiness", "sadness", "anger", "fear", "surprise", "disgust", "trust", "anticipation")
    }
}
