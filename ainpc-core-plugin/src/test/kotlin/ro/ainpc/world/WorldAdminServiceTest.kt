...
class WorldAdminServiceTest {
    ...
    fun createDemoSettlementBuildsMinimalPlayableMapping() {
        ...
        assertFalse(service.getPlace("demo_sat:fierarie")!!.hasTag("blacksmith"))
        assertFalse(service.getPlace("demo_sat:fierarie")!!.metadata().containsKey("profession"))
        assertEquals("work", service.getPlace("demo_sat:ferma")!!.metadata()["role"])
        assertFalse(service.getPlace("demo_sat:ferma")!!.metadata().containsKey("profession"))
